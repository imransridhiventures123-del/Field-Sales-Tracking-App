...
// OWNER: Imran — shows real user name and photo from AuthContext
...
const FAKE_RECENT = [
  { _id: "1", shopName: "Annas Provision Store", shopCode: "AP001", ownerName: "Annas", status: "Completed", categories: ["Grocery", "Provisions"], photos: [1, 2], createdAt: new Date().toISOString() },
    ...
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="bg-blue-600 px-4 pt-10 pb-8">
        <div className="flex items-center justify-between mb-1">
          ...
          {/* Avatar — shows real photo if registered */}
          <button
